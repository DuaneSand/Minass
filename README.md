...
Retargetable, by changing ~10 lines of opcode tables, and by adding Python code for parsing new source forms.
...
ken2020: An alternative to using TASM for Ken Boak's Suite-16 2020 variant, from Wozniak's Sweet-16 VM on Apple-2 computers.
